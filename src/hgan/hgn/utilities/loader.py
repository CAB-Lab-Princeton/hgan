...
from environments.datasets import EnvironmentSampler, EnvironmentLoader  # noqa: E402
from environments.environment_factory import EnvFactory  # noqa: E402
from hamiltonian_generative_network import HGN  # noqa: E402
from networks.decoder_net import DecoderNet  # noqa: E402
from networks.encoder_net import EncoderNet  # noqa: E402
from networks.hamiltonian_net import HamiltonianNet  # noqa: E402
from networks.transformer_net import TransformerNet  # noqa: E402
from utilities.integrator import Integrator  # noqa: E402
...
def load_hgn(params, device, dtype):
    ...
    # Define networks
    encoder = EncoderNet(
        seq_len=params["optimization"]["input_frames"],
        in_channels=params["dataset"]["rollout"]["n_channels"],
        **params["networks"]["encoder"],
        dtype=dtype
    ).to(device)
...
def get_online_dataloaders(params):
    ...
    test_data_loader = torch.utils.data.DataLoader(
        testDS, shuffle=False, batch_size=None
    )
